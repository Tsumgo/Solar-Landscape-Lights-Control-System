...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = 72 - 1; // pre scaler 72.clock APB2 works @ 72M Hz
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = 1000 - 1; // period
  ...
  sClockSourceConfig.ClockSource = TIM_CLOCKSOURCE_INTERNAL; // internal clock source
